...
if(st_is_valid(sf)){
      ...
      cat("cast to polygon and then st_area\n")
      ...
      cat("if cast and make valid doesn't work\n")
...
chr = rast("outputs/Drill_Down_Critical_Habitat.tif")
activeCat(chr) <- "VALUE"
...
ch_df = foreign::read.dbf("outputs/Drill_Down_Critical_Habitat.tif.vat.dbf")
